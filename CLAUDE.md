...
```mermaid
graph TD
  3503d9bd["ERC-721 NFT"]
  236d1301["Frontend"]
  033cb90c["Wallet Auth"]
  3503d9bd --> 236d1301
  236d1301 --> 033cb90c
```
...
1. **ERC-721 NFT** (`erc721-stylus`) — see `.nskills/components/erc721-stylus--3503d9bd.md`
2. **Frontend** (`frontend-scaffold`) — see `.nskills/components/frontend-scaffold--236d1301.md`
3. **Wallet Auth** (`wallet-auth`) — see `.nskills/components/wallet-auth--033cb90c.md`
...
- [ERC-721 NFT](.nskills/components/erc721-stylus--3503d9bd.md)
- [Frontend](.nskills/components/frontend-scaffold--236d1301.md)
- [Wallet Auth](.nskills/components/wallet-auth--033cb90c.md)
